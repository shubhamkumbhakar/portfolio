    ...
    return (
        <div id="home">
            ...
            <br/><br/>
                ...
                I am <Typical loop={Infinity} wrapper="b" steps={['a Programmer.', 1800, 'an Engineer.', 1800, 'a Web Developer.', 1800, 'an App Developer.', 1800, 'a Product Specialist.', 1800, 'an Artist.', 1800, 'a proud Indian.', 1800]}/>
                </p>
                </div><br/>
